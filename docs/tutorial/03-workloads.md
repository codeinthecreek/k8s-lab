...
controllers built on top of it (ReplicaSet, Deployment) that make Pods
self-healing and upgradeable rather than one-shot. It closes with a
different class of workload entirely - Job and CronJob - which exist to
run to completion rather than stay up.
