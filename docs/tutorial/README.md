...
| 2 | [The API model](02-api-model.md) | Declarative desired-state model, apiVersion/kind/metadata/spec, kubectl as an API client, what `apply` actually does (diff + PATCH, not blind create). First chapter with a YAML example. | not started |
